...
export class Rule extends Lint.Rules.AbstractRule {
    ...
    public apply(sourceFile: ts.SourceFile): Lint.RuleFailure[] {
        return this.applyWithFunction(sourceFile, walk, [parseOptions(this.ruleArguments[0], this.ruleArguments[1])])
    }
}

function parseOptions(pattern: string, message: string | undefined): IOption {
