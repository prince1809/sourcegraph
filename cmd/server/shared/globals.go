...
//
// This should be kept in sync with dev/src-prof-service.json.
var SrcProfServices = []map[string]string{
	...
	{"Name": "symbols", "Host": "127.0.0.1:6061"},
	{"Name": "repo-updater", "Host": "127.0.0.1:6074"},
	{"Name": "query-runner", "Host": "127.0.0.1:6067"},
	{"Name": "zoekt-indexserver", "Host": "127.0.0.1:6072"},
	{"Name": "zoekt-webserver", "Host": "127.0.0.1:3080", "DefaultPath": "/debug/requests/"},
}

// ProcfileAdditions is a list of Procfile lines that should be added to the emiited Procfile that
...
// DataDir is the root directory fot storing persistent data. It should NOT be modified by any
// external package.
