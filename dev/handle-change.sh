...
$generate_graphql && { go generate github.com/prince1809/sourcegraph/cmd/frontend/graphqlbackend || failed=true; }
$generate_graphql && { go generate githubcom/prince1809/sourcegraph/schema || failed=true; }
